...
public class Alert {
     ...
     */
    @NonNull
    public static AlertDialog showAlert(@NonNull Activity context, @NonNull CharSequence title, int layoutResource, int iconResource) {
     ...
     */
    @NonNull
    public static AlertDialog showAlert(@NonNull Activity context, @NonNull CharSequence title, int layoutResource) {
