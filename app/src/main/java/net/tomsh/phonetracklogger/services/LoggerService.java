...
import static net.tomsh.phonetracklogger.tasks.LoggerTask.E_DISABLED;
import static net.tomsh.phonetracklogger.tasks.LoggerTask.E_PERMISSION;
import static net.tomsh.phonetracklogger.ui.MainActivity.UPDATED_PREFS;
...
import net.tomsh.phonetracklogger.utils.LocationHelper;
...
public class LoggerService extends Service {
    ...
    public static final String BROADCAST_LOCATION_DISABLED = "net.tomsh.phonetracklogger.broadcast.location_disabled";
    public static final String BROADCAST_LOCATION_GPS_DISABLED = "net.tomsh.phonetracklogger.broadcast.gps_disabled";
    public static final String BROADCAST_LOCATION_GPS_ENABLED = "net.tomsh.phonetracklogger.broadcast.gps_enabled";
    public static final String BROADCAST_LOCATION_NETWORK_DISABLED = "net.tomsh.phonetracklogger.broadcast.network_disabled";
    public static final String BROADCAST_LOCATION_NETWORK_ENABLED = "net.tomsh.phonetracklogger.broadcast.network_enabled";
    public static final String BROADCAST_LOCATION_PERMISSION_DENIED = "net.tomsh.phonetracklogger.broadcast.location_permission_denied";
    public static final String BROADCAST_LOCATION_STARTED = "net.tomsh.phonetracklogger.broadcast.location_started";
    public static final String BROADCAST_LOCATION_STOPPED = "net.tomsh.phonetracklogger.broadcast.location_stopped";
    public static final String BROADCAST_LOCATION_UPDATED = "net.tomsh.phonetracklogger.broadcast.location_updated";
            ...
            if (!locationHelper.hasRequiredAccuracy(location)) {
                ...
                if (LocationHelper.isGps(location)) {
                    try {
                        ...
                        if (Logger.DEBUG) { Log.d(TAG, "[location updates restart failed: " + e.getMessage() + "]"); }
                    }
                }
                return false;
            }
